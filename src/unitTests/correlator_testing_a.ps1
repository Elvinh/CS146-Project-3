...
java -cp . wordcounter.Correlator -a .\txtFiles\hamlet.txt .\txtFiles\othello.txt
java -cp . wordcounter.Correlator -a .\txtFiles\hamlet.txt .\txtFiles\the-tempest.txt
java -cp . wordcounter.Correlator -a .\txtFiles\othello.txt .\txtFiles\the-tempest.txt
...
java -cp . wordcounter.Correlator -a .\txtFiles\essays.txt .\txtFiles\novum.txt
java -cp . wordcounter.Correlator -a .\txtFiles\essays.txt .\txtFiles\the-new-atlantis.txt
java -cp . wordcounter.Correlator -a .\txtFiles\novum.txt .\txtFiles\the-new-atlantis.txt

# Note median errorSum, note which txt files (hamlet, novum) contributed to smallest errorSums
""

java -cp . wordcounter.Correlator -a .\txtFiles\hamlet.txt .\txtFiles\novum.txt
java -cp . wordcounter.Correlator -a .\txtFiles\hamlet.txt .\txtFiles\king-james-bible.txt
java -cp . wordcounter.Correlator -a .\txtFiles\hamlet.txt .\txtFiles\alice.txt
java -cp . wordcounter.Correlator -a .\txtFiles\novum.txt .\txtFiles\king-james-bible.txt
java -cp . wordcounter.Correlator -a .\txtFiles\novum.txt .\txtFiles\alice.txt
java -cp . wordcounter.Correlator -a .\txtFiles\king-james-bible.txt .\txtFiles\alice.txt
...
"Elapsed Time Correlator AVL: $(($endDTMs1-$startDTMs1).totalseconds) seconds"